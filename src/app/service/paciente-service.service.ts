...
export class PacienteServiceService {
  ...
  private _paciente1: Paciente = new Paciente(1, "Vitor", "230918", "092387402", [this._consulta1]);
  private _paciente2: Paciente = new Paciente(2, "Eduardo", "230918", "092387402", [this._consulta2]);
  private _paciente3: Paciente = new Paciente(3, "Lucas", "213783", "023.903.123-44", [this._consulta3]);

  constructor() { }

  getTodosPacientes(): Paciente[] {
    return [this._paciente1, this._paciente2];
  }
